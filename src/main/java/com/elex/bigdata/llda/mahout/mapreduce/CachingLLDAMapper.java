 ...
 */
public class CachingLLDAMapper extends Mapper<Text, LabeledDocumentWritable, IntWritable, VectorWritable> {
  private static final Logger log = LoggerFactory.getLogger(CachingLLDAMapper.class);

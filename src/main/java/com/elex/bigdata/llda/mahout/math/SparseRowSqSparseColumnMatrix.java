 ...
 */
public class SparseRowSqSparseColumnMatrix extends AbstractMatrix {
  private SequencialSparseVector[] rowVectors;
  public SparseRowSqSparseColumnMatrix(int rows,int columns){
    super(rows,columns);
    rowVectors=new SequencialSparseVector[rows];
    Arrays.fill(rowVectors, null);
  }
  @Override
  public Matrix clone() {
    SparseRowSqSparseColumnMatrix clone = (SparseRowSqSparseColumnMatrix) super.clone();
  ...
  @Override
  public Matrix like() {
    return new SparseRowSqSparseColumnMatrix(rowSize(), columnSize());
  }

  @Override
  public Matrix like(int rows, int columns) {
    return new SparseRowSqSparseColumnMatrix(rows, columns);
  }

  @Override
  public void setQuick(int row, int column, double value) {
    if(rowVectors[row]==null){
      rowVectors[row]=new SequencialSparseVector(columnSize());
    }
  ...
  public Matrix assignRow(int row, Vector other) {
    ...
    rowVectors[row]=(SequencialSparseVector)other;
    return this;
  }
